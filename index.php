...
function fill_unit_selectbox($connect)
{
    $output  = '';
...
$(document).ready(function(){
    $(document).on('click', '.add', function(){
        ...
        html +='<td> <select  name="item_unit[]" class="form-control item_init"> <option value="">Select Unit </option><?php echo fill_unit_selectbox($connect); ?></select> </td>';
 ...
 $('#insert_form').on('submit', function(event){
     ...
     $('.item_name').each(function(){
         ...
         if($(this).val() == '')
         {
             error  +="<p> Enter Item Name at "+count+" </p>";
             return false;
         }
         count = count + 1;
     });
